...
const ja: LocaleStrings = {
  ...
  themeDark: 'ダーク',
  themeSystem: 'システム',
  alwaysOnTopLabel: '常に最前面に表示',
  launchAtStartupLabel: '起動時に自動実行',
  startMinimizedToTrayLabel: 'トレイに最小化して起動',
  startMinimizedToTrayHelp: '「起動時に自動実行」が有効な場合のみ適用されます',
  settingsTabGeneral: '一般',
  settingsTabAppearance: '外観',
  settingsTabStartup: '起動',
  cancel: 'キャンセル',
  save: '保存',
  getStarted: 'はじめる',
